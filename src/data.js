...
export let echartBarOption = {
    ...
    dataset: {
        source: [
            ...
            ["AUS,AUS", 0, 2005],
            ["BRN,AUS", 38.42, 2005],
            ["CAN,AUS", 7700.92, 2005],
            ["CHN,AUS", 2098.58, 2005],
            ["EU28,AUS", 25129.1, 2005],
            ["AUS,BRN", 40.39, 2005],
            ["BRN,BRN", 0, 2005],
            ["CAN,BRN", 46.47, 2005],
            ["CHN,BRN", 188.66, 2005],
            ["EU28,BRN", 133.82, 2005],
            ["AUS,CAN", 565.43, 2005],
            ["BRN,CAN", 0.85, 2005],
            ["CAN,CAN", 0, 2005],
            ["CHN,CAN", 31702.83, 2005],
            ["EU28,CAN", 28180.54, 2005],
            ["AUS,CHL", 120.7, 2005],
            ["BRN,CHL", 0.2, 2005],
            ["CAN,CHL", 257.35, 2005],
            ["CHN,CHL", 4141.18, 2005],
            ["EU28,CHL", 7132.5, 2005],
            ["AUS,EU28", 6050.7, 2005],
            ["BRN,EU28", 1.3, 2005],
            ["CAN,EU28", 18582.5, 2005],
            ["CHN,EU28", 132322.72, 2005],
            ["EU28,EU28", 0, 2005]
        ]
    },
    xAxis: [{
